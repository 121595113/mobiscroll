    ...
    function Scroller(elem, settings) {
        ...
        */
        that.change = function (manual) {
            ...
            if (s.display == 'inline') {
				...
				var dayCur=$('.dwv', dw).html();
                var dayCurYes=new Date(Date.parse(dayCur.replace(/-/g, '/')));
                var weekAll=new Array('星期日','星期一','星期二','星期三','星期四','星期五','星期六');
                var todayWeek=weekAll[dayCurYes.getDay()];
                $('.dwv', dw).html(dayCur +'<span class="todayWeek" style="margin-left:20px;">'+todayWeek+'</span>');
            }
        ...
        */
        that.show = function (prevAnim) {
            ...
            var html = '<div class="dw-trans ' + s.theme + ' dw-' + s.display + '">' + (s.display == 'inline' ? '<div class="dw dwbg dwi"><div class="dwwr" style="width:100%;">' : '<div class="dw-persp">' + '<div class="dwo"></div><div class="dw dwbg ' + mAnim + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' + (s.headerText ? '<div class="dwt">'+(s.title?s.title:'选择日期')+'</div><div class="dwv"></div>' : ''));
...
(function ($) {
    ...
    var ms = $.mobiscroll,
        ...
        defaults = {
            ...
            stepSecond: 1,
            separator: ' ',
            minDate: null,// 最小可选日期，默认为空 mind = s.minDate || new Date(s.startYear, 0, 1),
            maxDate: null// 最大可选日期，默认为空 maxd = s.maxDate || new Date(s.endYear, 11, 31, 23, 59, 59);
        },
